...
```{r echo=FALSE, message=FALSE, warning=FALSE}
combined_mandarin %>%
  ggplot(aes(x=num_uniq_word, y=this_freq, color=Score_Level)) +
  geom_point() +
  stat_smooth(method='lm') +
  labs(x= "Number of unique words in an essay",
        subtitle="Number of uniq words vs. Frequency of \"this\", Mandarin corpus")
```
...
combined_spanish %>%
  ...
  stat_smooth(method='lm') +
  labs(x= "Number of unique words in an essay",
        subtitle="Number of uniq words vs. Frequency of \"this\", Spanish corpus")
```

Plotting a freq vs. the freq
```{r echo=FALSE, message=FALSE, warning=FALSE}
combined_mandarin %>%
  ggplot(aes(x=aan_freq, y=the_freq, color=Score_Level)) +
  geom_point() +
  stat_smooth(method='lm') +
...
ggplot(combined_mandarin, aes(x=num_uniq_word)) +
  geom_point(aes(y=the_freq), col="blue") +
  geom_point(aes(y=this_freq+that_freq+these_freq+those_freq), col="red") + 
  geom_smooth(aes(y=the_freq), col="green") +
  geom_smooth(aes(y=this_freq+that_freq+these_freq+those_freq), col="green") +
  ...
  labs(subtitle="Frequency of \"the\" and the 4 demonstratives, Mandarin corpus")
