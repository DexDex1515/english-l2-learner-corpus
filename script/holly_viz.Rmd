...
ggplot(combined_mandarin, aes(x=log(num_uniq_word), y=noun_per_sentence/verb_per_sentence)) + geom_point() + stat_smooth(method='lm')
```
...
combined_mandarin %>%
  ...
  labs(x= "Number of unique words in an essay",
        subtitle="Number of uniq words vs. Frequency of \"the\", Mandarin corpus")
```
...
combined_spanish %>%
  ...
  stat_smooth(method='lm') +
  labs(x= "Number of unique words in an essay",
        subtitle="Number of uniq words vs. Frequency of \"the\", Spanish corpus")
```
